...
public enum SanctionUnit {
    ...
    ANTI_KB("Anti-knockback", "Ban", 1, TimeUnit.ANNEES, TimeUnit.ANNEES.getToSecond()),
    KILL_AURA("KillAura", "Ban", 1,  TimeUnit.ANNEES, TimeUnit.MOIS.getToSecond()),
    FAST_PLACE("FastPlace", "Ban", 1, TimeUnit.ANNEES, TimeUnit.ANNEES.getToSecond()),
    MACRO_CLICK("Macro Click", "Ban", 6, TimeUnit.MOIS, TimeUnit.MOIS.getToSecond()),
    REACH("Reach", "Ban", 1, TimeUnit.ANNEES, TimeUnit.ANNEES.getToSecond()),
    FLY("Fly/Glide", "Ban", 1, TimeUnit.ANNEES, TimeUnit.ANNEES.getToSecond()),
    TRICHE_AUTRE("Triche Autre", "Ban", 8, TimeUnit.MOIS, TimeUnit.MOIS.getToSecond()),
